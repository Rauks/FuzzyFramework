...
namespace core{
    ...
    public:
        ...
        virtual void setExpression(UnaryExpression<T>* exp);
        virtual UnaryExpression<T>* getExpression() const;
    };
    ...
    template<class T>
    UnaryExpression<T>* UnaryShadowExpression<T>::getExpression() const{
        return _exp;
    }
}
